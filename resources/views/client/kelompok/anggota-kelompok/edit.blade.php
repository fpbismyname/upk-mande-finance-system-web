<x-layouts.client-app title="Edit anggota kelompok">
    <div class="flex flex-col gap-4">
        <div class="flex flex-row">
            <div class="flex flex-col gap-2">
                <h3>Edit anggota kelompok</h3>
            </div>
        </div>
        <form action="{{ route('client.kelompok.anggota-kelompok.update', [$kelompok->id, $anggota_kelompok->id]) }}"
            ...
            <fieldset class="fieldset">
                ...
                <input class="input w-full validator" type="text" pattern="[0-9]{16}" name="nik" minlength="3"
                    maxlength="16" value="{{ $anggota_kelompok->nik }}" required />
            ...
            <fieldset class="fieldset">
                ...
                <input class="input w-full validator" type="text" name="name"
                    value="{{ $anggota_kelompok->name }}" required />
                <p class="validator-hint hidden">
            ...
            <fieldset class="fieldset">
                ...
                <input class="input w-full validator" type="text" name="nomor_telepon" pattern="[0-9]{10,16}"
                    minlength="10" maxlength="16" value="{{ $anggota_kelompok->nomor_telepon }}" required />
                <p class="validator-hint hidden">
            ...
            <div class="grid md:col-span-2">
                <fieldset class="fieldset">
                    ...
                    <textarea class="textarea w-full validator" type="text" name="alamat" required>{{ $anggota_kelompok->alamat }}</textarea>
                    <p class="validator-hint hidden">
                        Alamat wajib diisi.
                    </p>
                    @error('alamat')
