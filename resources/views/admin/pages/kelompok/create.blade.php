<x-layouts.admin-app title="Tambah kelompok upk" :breadcrumbs="$breadcrumbs">
    <div class="flex flex-col gap-4">
        {{-- Add form --}}
        @if ($list_ketua_kelompok->isNotEmpty())
            <form action="{{ route('admin.kelompok.add') }}" class="grid grid-cols-1 gap-2 md:grid-cols-2" method="POST">
                @csrf
                @method('post')
                {{-- Nama kelompok --}}
                <fieldset class="fieldset">
                    ...
                    <input type="text" name="name"
                        ...
                        class="input w-full validator" minlength="4" value="{{ old('name') }}" required />
                ...
                <fieldset class="fieldset">
                    ...
                    <p class="validator-hint hidden">
                        ...
                        <br>
                        {{ __('validation.min.numeric', ['Attribute' => 'Limit pinjaman', 'min' => 'Rp 1.000.000']) }}
                    </p>
