<x-layouts.admin-app :title="'Tambah anggota ' . $kelompok->name" :breadcrumbs="$breadcrumbs">
    <div class="flex flex-col gap-4">
        {{-- Add form --}}
        <form action="{{ route('admin.kelompok.anggota.add', [$kelompok->id]) }}"
            ...
            <fieldset class="fieldset">
                ...
                <input type="text" name="nik" placeholder="Nomor Induk Kependudukan" class="input w-full validator"
                    minlength="16" maxlength="16" value="{{ old('nik') }}" required />
            ...
            <fieldset class="fieldset">
                ...
                <input type="text" name="name" placeholder="Nama anggota kelompok" class="input w-full validator"
                    minlength="4" value="{{ old('name') }}" required />
                <p class="validator-hint hidden">
            ...
            <fieldset class="fieldset">
                ...
                <textarea name="alamat" placeholder="Alamat lengkap" class="textarea w-full validator" minlength="10" required>{{ old('alamat') }}</textarea>
                <p class="validator-hint hidden">
            ...
            <fieldset class="fieldset">
                ...
                <input type="tel" inputmode="tel" name="nomor_telepon" placeholder="Nomor telepon"
                    class="input w-full validator" minlength="10" maxlength="13" value="{{ old('nomor_telpon') }}"
                    required />
                <p class="validator-hint hidden">
